        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(com.orders.home.ordersHome.hacer_pedido.this,android.R.layout.simple_spinner_item,sucursales);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(success) {
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<String>(com.orders.home.ordersHome.hacer_pedido.this, android.R.layout.simple_spinner_item, tagDirecciones);
                        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
